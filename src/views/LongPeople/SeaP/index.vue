  ...
  <div>
    <div>
      <List :dataList="dataList" @handleXiangQing="handleXiangQing" @onGetAll="onGetAll" :current="current"
        :pageSize="pageSize" @onSubmit="onSubmit"></List>
      <!-- 分页组件 -->
    ...
    <el-dialog v-if="flag" style=";" title="详细信息" :visible.sync="flag">
      <XiangQing :msg="this.msg" @getAll="getAll(current)" @handleXiangQing="handleXiangQing" @handlequxiao="handlequxiao"></XiangQing>
